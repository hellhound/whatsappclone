...
- (float)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    {
        return MAX([UIBubbleTypingTableViewCell height], self.showAvatars ? 40 : 0) + kMargin * 2.;
    }
    ...
    return MAX(data.insets.top + data.view.frame.size.height + data.insets.bottom, self.showAvatars ? 5 : 0) + kMargin * 2.;
}
