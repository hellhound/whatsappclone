...
@synthesize withBubble = _withBubble;
...
const UIEdgeInsets textInsetsMine = {11, 10, 11, 17};
const UIEdgeInsets textInsetsSomeone = {11, 15, 11, 10};
...
- (id)initWithText:(NSString *)text date:(NSDate *)date type:(NSBubbleType)type
{
    ...
    CGSize size = [(text ? text : @"") sizeWithFont:font constrainedToSize:CGSizeMake(225, 9999) lineBreakMode:UILineBreakModeWordWrap];
...
const UIEdgeInsets imageInsetsMine = {11, 13, 5, 22};
const UIEdgeInsets imageInsetsSomeone = {11, 18, 5, 14};
